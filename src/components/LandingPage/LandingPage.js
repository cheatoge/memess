        ...
        <p className='landing-paragraph'>
          Created by <a href='https://github.com/cheatoge'>
            <span className='landing-authors'>
              <span className='landing-icon-wrapper'><GithubMark fill={getCSSVariable('--color-primary')} /></span><b>cheatoge</b>
            </span>
          </a>.

          Original idea by <a href='https://github.com/pr0gramista'>
            <span className='landing-authors'>
              <span className='landing-icon-wrapper'><GithubMark fill={getCSSVariable('--color-primary')} /></span><b>pr0gramista</b>
            </span>
          </a>.
        </p>
      </div>
